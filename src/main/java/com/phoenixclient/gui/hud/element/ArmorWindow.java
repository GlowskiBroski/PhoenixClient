...
public class ArmorWindow extends GuiWindow {
    ...
    protected void drawWindow(GuiGraphics graphics, Vector mousePos) {
        ...
        if (Minecraft.getInstance().screen == getScreen()) {
            ResourceLocation helmet = ResourceLocation.withDefaultNamespace("textures/gui/sprites/container/slot/helmet.png");
            ResourceLocation chestplate = ResourceLocation.withDefaultNamespace("textures/gui/sprites/container/slot/chestplate.png");
            ResourceLocation leggings = ResourceLocation.withDefaultNamespace("textures/gui/sprites/container/slot/leggings.png");
            ResourceLocation boots = ResourceLocation.withDefaultNamespace("textures/gui/sprites/container/slot/boots.png");
